(function($) {
    ...
    // t Slider Js
      ...
      // t Slider Js
        var slider = new Swiper('.testi-slider-container2', {
          autoplay: {
            delay: 4000,
          },
          slidesPerView : 1,
        ...
        var thumbs = new Swiper('.testi-thumbs', {
          slidesPerView: 3,
          spaceBetween: 10,
          centeredSlides: true,
          loop: true,
    ...
    // Blog Details Slider Js
      ...
      // Portfolio Details Slider Js
        var swiper = new Swiper('.portfolio-big-slider', {
          slidesPerView : 1.8,
          spaceBetween: 150,
          centeredSlides: !0,
          loop: !0,
          ...
          effect: "coverflow",
          coverflowEffect: { rotate: 0, stretch: 0, depth: 200, modifier: 1, slideShadows: !0 },
          onmouseover: { autoplay: !1 },
          pagination: { el: ".swiper-pagination", clickable: !0 },
          navigation: { nextEl: ".swiper-button-next", prevEl: ".swiper-button-prev" },
          breakpoints: { 768: { slidesPerView: 2.1 }, 992: { slidesPerView: 2.03 }, 1199: { slidesPerView: 2 }, 1280: { slidesPerView: 1.8 } },        
          // navigation: {
          //     nextEl: '.portfolio-big-slider .swiper-button-next',
          //     prevEl: '.portfolio-big-slider .swiper-button-prev',
          // },
        });
